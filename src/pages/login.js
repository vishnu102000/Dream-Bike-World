    ...
    .catch(err=>console.log(err))
      ...
      return(
        ...
        <div className="logform" >
          ...
          <button onClick={handleSubmit} type="submit" className="button1" style={{fontWeight:"bold"}}>L O G I N</button> <br/>
          <div className="box" style={{marginTop:"20px"}}>
            <input type="checkbox" id="checkbox"/><span style={{fontFamily:"monospace",fontSize:"18px", margin:"auto"}}> Remember Me</span> <br/><br/>
          </div>
          <p className="reg"><a href="newpass" id="fpass"> Forget Password</a> <a  href="log" id="new"> New User </a></p>
