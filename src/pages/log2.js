    ...
    return(
        <div className="logform2" >
            <form className="form" onSubmit={handleSubmit} >
                ...
                <button onClick={handleSubmit} type="submit" className="logtwo" style={{fontWeight:"bold"}}><a href="#" style={{textDecorationLine:"none", color:"white"}}>L O G I N</a></button> <br/>
                <div className="box" style={{marginTop:"20px"}}>
                <input type="checkbox" id="checkbox"/><span style={{fontFamily:"serif",fontSize:"20px", margin:"auto"}}> Remember Me</span> <br/><br/>
                </div>
